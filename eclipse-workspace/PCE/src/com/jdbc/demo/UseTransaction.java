...
public class UseTransaction {
	...
	public static void main(String[] args)  {
			...
			String query1 = "update account set balance = balance -? where acc_number=?";
	        String query2 = "update account set balance  = balance +? where acc_number=?";//error in this line se = set 
